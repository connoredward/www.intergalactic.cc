...
let socialMediaIcons = [
  ...
  {
    href: 'https://open.spotify.com/playlist/3BXxN58hWM8QHDNAWPExSH?si=Np_2QauNThO_gU9qMgOVWg',
    icon: SPOTIFY_ICON,
  },
];
    ...
    <div className={classNames(styles.main, className)}>
      ...
      <div className={styles['footer_bottom_row']}>
        <div className={styles['footer_description']}>
          <p>
            We collaborate with artists, brands, labels and agencies to create visuals that are out
            of this world.
          </p>
        </div>
        <br />
        <a className={styles.email} target="_blank" rel="noreferrer" href="mailto:hello@intergalacticstudios.com">
        ...
        <div className={styles['footer_contact_info']}>
          <a className={styles.number} href="tel:442086915534">
            +44 20 8691 5534
          </a>
